...
description: Capture architectural decisions made during Copilot/Codex/ClaudeCode/Antigravity sessions as structured ADRs. Auto-detects decision moments, records context, alternatives considered, and rationale. Maintains an ADR log so future developers understand why the codebase is shaped the way it is.
metadata:
...
|-----|-------|--------|------|
| [0001](0001-use-reactjs.md) | Use reactJS as frontend framework | accepted | 2026-01-15 |
